...
ROWS = 16
MAX_COLS = 150
TILE_SIZE = SCREEN_HEIGHT // ROWS   # 40
#20
TILE_TYPES = 27
level = 0
current_tile = 0
...
img_list = []
for x in range(0, TILE_TYPES+1):
    img = pygame.image.load(f'img/maptile/{x}.png').convert_alpha()
...
def draw_bg():
    ...
    for x in range(4):
        ...
        screen.blit(mountain_img, ((x * width2) - scroll * 0.5, SCREEN_HEIGHT - mountain_img.get_height() - 100))
        screen.blit(pine1_img, ((x * width3) - scroll * 0.8, SCREEN_HEIGHT - pine1_img.get_height() - 0))
        screen.blit(pine2_img, ((x * width4) - scroll * 1, SCREEN_HEIGHT - pine2_img.get_height()))
